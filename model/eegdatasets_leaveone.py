...
img_directory_training = "/mnt/dataset0/ldy/datasets/THINGS_EEG/images_set/training_images"#config["img_directory_training"]
...
class EEGDataset():
    ...
    def __init__(self, data_path, exclude_subject=None, subjects=None, train=True, time_window=[0, 1.0], classes = None, pictures = None, val_size=None):
        ...
        if self.classes is None and self.pictures is None:
            ...
            features_filename = os.path.join(f'/mnt/dataset1/ldy/Workspace/FLORA/data_preparing/ViT-H-14_features_train.pt') if self.train else os.path.join(f'/mnt/dataset1/ldy/Workspace/FLORA/data_preparing/ViT-H-14_features_test.pt')
